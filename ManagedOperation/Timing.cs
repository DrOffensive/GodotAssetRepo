...
// /////////////////////////////////////////////////////////////////////////////////////////
//
// Modified by MarcWerk. October 2023
//
...
namespace MEC
{
	public partial class Timing : Node
	{
		...
		public static bool IsRunning (CoroutineHandle coroutine)
		{
			Timing inst = GetInstance(coroutine.Key);
			if (inst != null && inst._handleToIndex.ContainsKey(coroutine))
			{
				if (inst.CoindexIsNull(inst._handleToIndex[coroutine]))
					return false;
